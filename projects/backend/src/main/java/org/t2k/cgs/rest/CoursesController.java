...
import org.t2k.cgs.rest.dto.CourseInfoDTO;
...
//        courseDataService.saveCourse(courseCGSObject, new LockUser(currentCgsUserDetails), false);
     ...
     * @throws org.t2k.cgs.dataServices.exceptions.ResourceNotFoundException if entity does not exists
     */
