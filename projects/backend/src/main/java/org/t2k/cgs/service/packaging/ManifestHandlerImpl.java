...
import org.t2k.cgs.config.app.ManifestHandlerConfiguration;
...
public class ManifestHandlerImpl implements ManifestHandler {
    ...
    @Override
    public void handlePackageManifest(PackageHandlerImpl packageHandler) throws Exception { // fixme change dependency to PackageHandler
