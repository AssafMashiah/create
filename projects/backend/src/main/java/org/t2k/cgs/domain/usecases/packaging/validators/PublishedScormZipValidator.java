...
public class PublishedScormZipValidator {
    ...
    public PublishedScormZipValidator(Resource scormSchemasZip,
                                      PublishedStandAloneZipValidator publishedStandAloneZipValidator)
            throws Exception {
        this.scormSchemasZip = scormSchemasZip;
        this.publishedStandAloneZipValidator = publishedStandAloneZipValidator;
        init();
    }
