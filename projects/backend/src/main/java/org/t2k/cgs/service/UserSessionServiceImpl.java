...
public class UserSessionServiceImpl implements UserSessionService {
    ...
    public void init() {
        ...
        try {
            logger.debug(String.format("init: About to update all inactive sessions with destruction date and status '%s'", UserSessionStatus.DestroyedOnTimeOutReached.name()));
