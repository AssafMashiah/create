package org.t2k.cgs.persistence.dao.standards;
...
public class StandardsDaoTest extends AbstractTestNGSpringContextTests {
    ...
    public void getStandardHeadersAndGetPackageTest() throws JSONException, IOException, DaoException, DsException {
        ...
        String ccssPackageFromDB = standardsDao.getStandardsPackage(ccssPackage.get(NAME_ID_ATTRIBUTE_NAME).toString(),ccssPackage.get(SUBJECT_AREA_ATTRIBUTE_NAME).toString(),ccssPackage.get(VERSION_ATTRIBUTE_NAME).toString());
