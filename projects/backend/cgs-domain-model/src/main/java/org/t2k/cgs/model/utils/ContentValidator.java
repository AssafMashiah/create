 ...
 * Time: 18:18
 */
@Service(value = "contentValidatorBean")
public class ContentValidator {
    ...
    @Value("classpath:schema/course_v7.json")
    private Resource courseJsonSchemaResource;
    private String schemaName;

    public ContentValidator() {

//        final JsonNode customSchema = null;// loadResource("/custom-keyword.json");
//
//        final MetaSchema metaSchema = MetaSchema.basedOn(BuiltinSchemas.DRAFTV4_CORE)
//                .build();
//
...
//        final JsonSchema schema = factory.fromSchema(customSchema);
    ...
    public void initValidators() throws IOException, ValidationException {
        ...
        Reader reader = null;
        try {
            reader = new BufferedReader(new InputStreamReader(courseJsonSchemaResource.getInputStream()));
     ...
     * @throws org.t2k.cgs.dataServices.exceptions.ValidationException when validation fails
     */
