...
html2canvas = function( elements, opts ) {
    ...
    //create a canvas and return a base64 png
    var _convertImageToCanvas= function(image) {
        var canvas = document.createElement("canvas");
        ...
        try {
            canvasBase64 = canvas.toDataURL("image/png");
        } catch (e) {
            canvasBase64 = "data:image/png;base64,";
        }

        return canvasBase64;
    };

    //handler all the images to base64 (files are in the local file system)
    var _base64Handler = function(){

        var i,canvas,base64Result,imagesArray;




        imagesArray = $(options.elements[0]).find("img");//all the image that need to convert

        for(i=0;i<imagesArray.length;i++){
            if(imagesArray[i].src.indexOf("play.svg") < 0){
                base64Result = _convertImageToCanvas(imagesArray[i]);
                //switch
                $(imagesArray[i]).attr("src",base64Result);
            }else{
               var playData = "data:image/png;base64,";
                $(imagesArray[i]).attr("src",playData);
            }
