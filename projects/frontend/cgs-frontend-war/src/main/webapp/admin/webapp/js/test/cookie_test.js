define(['jquery', 'cookie'], function($) {
	...
	module('jquery.cookie.js (read)', before);
	...
	*/
	...
	module('jquery.cookie.js (write)', before);
	...
	module('jquery.cookie.js (delete)', before);
	...
	module('jquery.cookie.js (removeCookie)', before);
