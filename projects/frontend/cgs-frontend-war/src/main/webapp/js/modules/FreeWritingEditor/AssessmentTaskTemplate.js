define({ template:'[	{	"id":"{{id1}}",\
						...
						{	"id":"{{id5}}",\
							...
							"data": {"ignore_defaults": "true", "title": "Progress", "show_hint" : false, "button_label" : "Continue",\
									"feedback_type" : "none", "disableDelete":true, "hint_timing": 1, "showOnlyAlways": true, "score" : 1	}\
						},\
						{	"id":"{{id6}}",\
							"type": "hint",\
							"parent": "{{id5}}",\
						...
						{	"id":"{{id7}}",\
							...
							"parent": "{{id2}}",\
							"children": [],\
							"data": {"title": "{{{freeWritingInstruction}}}", "disableDelete":true, "styleOverride": "instruction", "stageReadOnlyMode":true}\
						},\
						{	"id":"{{id8}}",\
							"type": "textEditor",\
							"parent": "{{id4}}",\
