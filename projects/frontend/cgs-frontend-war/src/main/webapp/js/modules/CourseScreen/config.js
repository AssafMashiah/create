define(['repo', 'publishModel'], function(repo, publishModel) {

	var shareALinkButton = { subMenuItems: [] };

	if (AuthenticationData.account.publishSettings.courses.enablePublishToUrl) {
		shareALinkButton = {
			'label': '((lesson.toolbar.Share.a.link))',
			'type': 'btn-group',
			'subMenuItems': [{
				'id': 'menu-button-share-a-link',
